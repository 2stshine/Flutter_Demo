                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    PersonCard(
                      ...
                      imageName: 'beast.png',
                      onTap: () => _showPersonInfo(
                          'Mr.Beast : 전세계 1위 유튜버 \n\n\u{1f440} 이런 분들께 추천해요! \n\u{1f446} 인기 유튜버가 되고 싶은 사람 \n\u{1f446} 어디로 튈 지 모르는 재미있는 삶을 살고 싶은 사람 \n\u{1f446} 이타적인 삶을 살고 싶은 사람 \n'),
                    ),
                    // 추가된 인물 카드
                    PersonCard(
                      name: '김동희',
                    ...
                    PersonCard(
                      ...
                      onTap: () => _showPersonInfo(
                          '유재석: 예능인\n\n\u{1f440} 이런 분들께 추천해요! \n\u{1f446} 많은 사람들에게 사랑 받고 싶은 사람 \n\u{1f446} 유머 있는 사람이 되고 싶은 사람 \n\u{1f446} 유재석을 좋아하는 사람 \n'),
                    ),
                    PersonCard(
                      name: '톰 크루즈',
                      imageName: 'tom.png', // 이미지 파일 이름 확인
                      onTap: () => _showPersonInfo(
                          '톰 크루즈: 할리우드 배우 \n\n\u{1f440} 이런 분들께 추천해요! \n\u{1f446} 배우가 되고 싶은 사람 \n\u{1f446} 도전에 대한 갈망이 있는 사람 \n\u{1f446} 스릴을 즐기는 사람 \n'),
                    ),
                    PersonCard(
                      name: 'RIIZE 원빈',
                      imageName: 'wonbin.png', // 이미지 파일 이름 확인
                      onTap: () => _showPersonInfo(
                          'RIIZE 원빈: 아이돌 \n\n\u{1f440} 이런 분들께 추천해요! \n\u{1f446} 엔터테이너가 되고 싶은 사람 \n\u{1f446} 유명인이 되고 싶은 사람 \n\u{1f446} 자기 관리가 필요한 사람 \n'),
                    ),
                    PersonCard(
                      name: '오바마',
                      imageName: 'obama.png', // 이미지 파일 이름 확인
                      onTap: () => _showPersonInfo(
                          '오바마: 전 미국 대통령 \n\n\u{1f440} 이런 분들께 추천해요! \n\u{1f446} 정치인을 꿈꾸는 사람 \n\u{1f446} 전세계 No.1이 되어보고 싶은 사람 \n\u{1f446} 대통령의 삶이 궁금한 사람 \n'),
                    ),
                  ]),
                ),
              ),
